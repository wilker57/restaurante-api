...
public class MovimentoEstoqueController {
    ...
    public MovimentoEstoqueController(RegistroEstoqueNegocio registroEstoqueNegocio) {
        this.registroEstoqueNegocio = registroEstoqueNegocio;
    }

    @GetMapping(value = "/tipos", produces = MediaType.APPLICATION_JSON_VALUE)
    public MovimentoEstoqueDTO[] buscarTipos() {
        return MovimentoEstoqueDTO.values();
    }
    ...
    @GetMapping(value = "/tipo/{movimento}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/tipo/{movimento}/data/{data}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public RegistroEstoqueDTO inserirMovimento(@RequestBody RegistroEstoqueDTO registroEstoqueDTO)
            throws NotFoundException, NotValidDataException {
        return registroEstoqueNegocio.inserir(registroEstoqueDTO);
    }

    @PutMapping(consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public RegistroEstoqueDTO alterarMovimento(@RequestBody RegistroEstoqueDTO registroEstoqueDTO)
            throws NotFoundException, NotValidDataException {
        return registroEstoqueNegocio.alterar(registroEstoqueDTO);
    }

    @DeleteMapping(consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public RegistroEstoqueDTO excluirMovimento(@RequestBody RegistroEstoqueDTO registroEstoqueDTO)
            throws NotFoundException, NotValidDataException {
